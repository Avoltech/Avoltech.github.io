...
<br>
<li>(future work) The images need to be in as specified on the site. To have the program work on unproper angles and image skewness, preprocessing can be done on the image before feeding it to the algorithm, this can be easily done using OpenCV</li>
</ul> 
<br>
